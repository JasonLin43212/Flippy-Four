...
public class Animation extends JPanel implements ActionListener {
  ...
  public void paintComponent(Graphics g) {
    ...
    //Drawing background
    int[] triangle1X = new int[] {
      0,
      0,
      width
    };
    int[] triangle1Y = new int[] {
      0,
      height - 30,
      height - 30
    };
    int[] triangle2X = new int[] {
      0,
      width,
      width
    };
    int[] triangle2Y = new int[] {
      0,
      0,
      height - 30
    };
